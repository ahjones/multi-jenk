...
multi_jenk.client.main.job = function(a) {
  ...
  a.setAttribute("crateGroup", group__3192__auto____79406);
  return a
};
...
multi_jenk.client.main.jobs_list = function(a) {
  ...
  a.setAttribute("crateGroup", group__3192__auto____79415);
  return a
};
...
multi_jenk.client.main.render_server = function(a, b) {
  var c = crate.core.html.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'p", cljs.core.PersistentVector.fromArray(["\ufdd0'h1", a]), cljs.core.PersistentVector.fromArray(["\ufdd0'h2", b])]));
  c.setAttribute("crateGroup", group__3192__auto____79423);
  return c
};
...
multi_jenk.client.main.servers_list = function(a) {
  ...
  a.setAttribute("crateGroup", group__3192__auto____79425);
  return a
};
...
multi_jenk.client.main.got_servers = function(a) {
  a = multi_jenk.client.main.reply__GT_clojure.call(null, a);
  a = cljs.core.seq.call(null, a);
  if(cljs.core.truth_(a)) {
    for(var b = cljs.core.first.call(null, a);;) {
      var c = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, b)) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, b = cljs.core.get.call(null, c, "info"), c = cljs.core.get.call(null, c, "name");
      cljs.core.swap_BANG_.call(null, multi_jenk.client.main.servers, cljs.core.assoc, c, b);
      jayq.core.append.call(null, multi_jenk.client.main.$jenkins, multi_jenk.client.main.render_server.call(null, c, b));
      a = cljs.core.next.call(null, a);
      if(cljs.core.truth_(a)) {
...
multi_jenk.client.main.call_with_callback = function(a, b) {
