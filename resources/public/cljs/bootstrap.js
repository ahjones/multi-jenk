...
multi_jenk.client.main.storage_put = function(a, b) {
  return goog.dom.getWindow.call(null).localStorage.setItem(a, b)
};
multi_jenk.client.main.storage_get = function(a) {
  return goog.dom.getWindow.call(null).localStorage.getItem(a)
};
